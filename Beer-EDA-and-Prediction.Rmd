...
We will perform a cross validation with k = 1-60 with a plot of k (x-axis) versus accuracy.  We will use this plot to tune the hyperparameter k. 
```{r}
...
Below is a loop to repeat the previous KNN for 25 different random seeds. We will find the average accuracy to get a more stable statistic to evaluate the model.
```{r}
splitPerc <- .7
iterations = 25
numks = 60
...
Based off our averages, KNN accurately predicted about 87% of the time, which slightly outperformed Naive Bayes again, at 84.5%.
